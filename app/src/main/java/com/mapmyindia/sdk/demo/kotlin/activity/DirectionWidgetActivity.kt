...
class DirectionWidgetActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        beginTransaction().
        add(mBinding.fragmentConatiner.id, directionFragment, DirectionFragment::class.java.simpleName).
        commit()
        ...
        directionFragment.setDirectionCallback(object : DirectionCallback {
            ...
            override fun onStartNavigation(directionPoint: DirectionPoint, directionPoint1: DirectionPoint, list: List<DirectionPoint>, directionsResponse: DirectionsResponse, i: Int) {
                Toast.makeText(this@DirectionWidgetActivity, "On Navigation Start", Toast.LENGTH_SHORT).show()
            }
        })
    }
}