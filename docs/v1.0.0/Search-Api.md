...
MapmyIndiaGeoCoding.builder()  
        .setAddress("Delhi")  
        .build()  
        .enqueueCall(object : Callback<GeoCodeResponse> {  
...
MapmyIndiaReverseGeoCode.builder()  
        ...
        .build()  
        .enqueueCall(object : Callback<PlaceResponse> {  
...
MapmyIndiaPlaceDetail.builder()  
        .eLoc("mmi000")  
        .build()  
        .enqueueCall(object : Callback<PlaceDetailResponse> {  
...
MapmyIndiaPOIAlongRoute.builder()  
        ...
        .path(path)  
        .build()  
        .enqueueCall(object : Callback<POIAlongRouteResponse> {  
