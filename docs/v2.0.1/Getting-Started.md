...
#### Java
```java
MapmyIndiaAccountManager.getInstance().setRestAPIKey("SET_REST_API_KEY");
MapmyIndiaAccountManager.getInstance().setMapSDKKey("SET_MAP_KEY");
MapmyIndiaAccountManager.getInstance().setAtlasClientId("SET_CLIENT_ID");
MapmyIndiaAccountManager.getInstance().setAtlasClientSecret("SET_CLIENT_SECRET");
