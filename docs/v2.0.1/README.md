...
| ---- | ---- | 
| [v2.0.1](./README.md) | - Map SDK v7.0.3 <br/> - Geo Analytics v0.2.0 <br/> - Place Search Widget v1.6.0 <br/> - GeoFence Widget v0.10.0 <br/> - Scalebar Plugin v0.2.0 <br/> - Direction Widget v0.4.0 <br/> - Nearby UI Widget v0.2.0 <br/> - Driving Range Plugin v0.0.1|
