...
~~~groovy	
implementation 'com.mapmyindia.sdk:direction-ui:0.4.0'
~~~	
...
To access this parameter , please contact [API Support](mailto:apisupport@mapmyindia.com) This parameter takes the encoded route along which POIs will be searched.
